...
define('BASE_URL', 'http://' . 'localhost:8000/intranet');
...
$router->add('/home/permissao', 'homeController.permissao');
...
// Client Achados Perdidos
$router->add('/achados-perdidos', 'achadosPerdidosController.index');
$router->add('/achados-perdidos/criar', 'achadosPerdidosController.create');
$router->add('/achados-perdidos/{id}/editar', 'achadosPerdidosController.edit');
...
if (strpos($_SERVER['REQUEST_URI'], "admin")) {
  ...
  if (in_array(
    ...
    $router->add('/admin/cargos', 'adminCargosController.index');
    $router->add('/admin/cargos/criar', 'adminCargosController.create');
    $router->add('/admin/cargos/{id}/editar', 'adminCargosController.edit');

    $router->add('/admin/departamentos', 'adminDepartamentosController.index');
    $router->add('/admin/departamentos/criar', 'adminDepartamentosController.create');
    $router->add('/admin/departamentos/{id}/editar', 'adminDepartamentosController.edit');


    $router->add('/admin/politicas', 'politicasController.index');
    $router->add('/admin/politicas/criar', 'politicasController.store');
    $router->add('/admin/politicas/{id}/edit', 'politicasController.edit');

    $router->add('/admin/noticias', 'noticiasController.index');
    $router->add('/admin/noticias/criar', 'noticiasController.store');
    $router->add('/admin/noticias/{id}/edit', 'noticiasController.edit');

    $router->add('/admin/home-design', 'adminHomeDesignController.index');
...
$router->add('/politicas', 'politicasController.index');
...
$router->add('/lgpd', 'LGPDController.index');
$router->add('/lgpd/criar', 'LGPDController.create');
$router->add('/lgpd/{id}/editar', 'LGPDController.edit');
