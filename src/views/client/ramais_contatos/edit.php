<div class='container-fluid'>
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb" style="background: #fff; padding: .75rem 0px; margin-bottom: 0px">
      ...
      <li class="breadcrumb-item"><a class="title-container" href="<?= BASE_URL ?>ramais-contatos">Ramais</a></li>
  ...
  <form method="POST">
    <div class="form-row">
      <div class="form-group col-md-5">
        ...
        <input type="text" name="nome" value="<?= $ramal['nome']; ?>" class="form-control">
      </div>
      <div class="form-group col-md-5">
        <label for="inputCity">Ramal:</label>
        <input type="text" name="ramal" value="<?= $ramal['ramal']; ?>" class="form-control">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-5">
        <label for="inputCity">Celular:</label>
        <input type="text" name="celular" value="<?= $ramal['celular']; ?>" class="form-control">
      </div>
    </div>
