<div class="container-baseconhecimento">
    ...
    <a class="btn btn-success" href="<?= BASE_URL ?>admin/cargos/criar"> Adicionar </a>
            ...
            <tbody>
                <?php foreach ($cargos as $cargo) : ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" style="color:white;" href="<?= BASE_URL ?>admin/cargos/<?= $cargo['id'] ?>/editar">
