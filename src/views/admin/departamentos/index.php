<div class="container-baseconhecimento">
    ...
    <a class="btn btn-success" href="<?= BASE_URL ?>admin/departamentos/criar"> Adicionar </a>
            ...
            <tbody>
                <?php foreach ($departamentos as $departamento) : ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" style="color:white;" href="<?= BASE_URL ?>admin/departamentos/<?= $departamento['id'] ?>/editar">
