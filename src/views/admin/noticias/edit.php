  ...
  <form action="" method="post" id="form-base" enctype="multipart/form-data">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <label> Titulo: </label>
          <input class="form-control" name="titulo" id="titulo" value="<?= $noticia['titulo'] ?>" />
        </div>
        <div class="col-md-6">
          <label> Link: </label>
          <input class="form-control" name="link" id="titulo" value="<?= $noticia['link'] ?>" />
        </div>
      </div>
      ...
      <!-- <div class="row mt-3">
        <div class="col-md-6">
          ...
          <select name="slide" id="slide" class="form-control">
            <option value="1" <?php echo ($noticia['slide'] === '1') ? 'selected' : ''; ?>> Slide 1</option>
            <option value="2" <?php echo ($noticia['slide'] === '2') ? 'selected' : ''; ?>> Slide 2</option>
          </select>
        </div>
      </div> -->
