    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-10">
          ...
          <input class="form-control" name="desc_curta" id="desc_curta" />
        </div>
      </div>
      <div class="row">
        <div class="col-md-3">
...
<div class="modal fade" id="modal-sub-categoria" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <label for=""> Categoria </label>
        <select class="form-control" name="categoria-modal" data-id="" id="categoria-modal-sub">
          <option value="0"> Selecionar...</option>
        </select>
        <label for=""> Sub Categoria </label>
        <select class="form-control" name="sub-categoria" id="sub-categoria-modal" data-id="">
          <option value=" 0"> Selecionar...</option>
        </select>
      </div>
      <div id="options-modal">
