    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-row">
            <div class="form-group col-md-10">
                ...
                <input type="text" id="titulo" name="titulo" value="<?= $lgpd['titulo'] ?>" class="form-control" />
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-5">
                <label for="inputCity">Data Criação</label>
                <input type="date" name="data_criacao" value="<?= $lgpd['data_criacao'] ?>" class="form-control" id="inputCity">
            </div>
            <div class="form-group col-md-5">
                <label for="versao">Versão </label>
                <input type="text" id="versao" name="versao" value="<?= $lgpd['versao'] ?>" class="form-control" />
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-10">
                <label for="inputZip">Aprovadores</label>
                <input type="text" name="aprovadores" value="<?= $lgpd['aprovadores'] ?>" class="form-control" id="inputZip">
            </div>
        </div>
