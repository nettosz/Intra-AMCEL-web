<div class="container-baseconhecimento">
    ...
    <a class="btn btn-success" href="<?= BASE_URL ?>admin/lgpd/criar"> Adicionar </a>
            ...
            <tbody>
                <?php foreach ($lgpds as $lgpd) : ?>
                    <tr>
                        ...
                        <td><?= $lgpd['titulo']; ?></td>
                        <td>
                            <a class="btn btn-warning" style="color:white;" href="<?= BASE_URL ?>admin/lgpd/<?= $lgpd['id'] ?>/editar"> <i class="fa fa-pencil" aria-hidden="true"></i> </a>
                            <a data-toggle="modal" data-target="#exampleModal" data-id="<?= $lgpd['id']; ?>" class="btn btn-danger" href="<?= BASE_URL ?>admin/videos/<?= $lgpd['id'] ?>/delete"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
                        </td>
                    </tr>
                <?php endforeach; ?>
        </table>
