...
if (document.querySelector("#form-base")) {
  ...
  formSalvar.addEventListener("submit", async (e) => {
    ...
    const desc_curta = document.querySelector("#descricao");
  ...
  function salvar([...params]) {
    ...
    params1.append("token", token);
    params1.append("titulo", params[0].value);
    params1.append("descricao", params[1].value);
    params1.append("sub_categoria", params[2].value);
    params1.append("url_video", params[3].value);
...
if (document.querySelector("#form-video-edit")) {
  let formEdit = document.querySelector("#form-video-edit");
  ...
  function editar([...params]) {
    ...
    formEdit.style.pointerEvents = "none";
    formEdit.style.opacity = "0.5";
    return server({
      method: "POST",
      url: `/admin/videos/${id_video}/update`,
      data: params1,
    }).then((response) => {
      formEdit.style.pointerEvents = "all";
